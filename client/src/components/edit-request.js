  ...
  getEventById(requestId) {
    axios.get("/requests/ind/" + requestId).then(res => {
      ...
      this.setState({
        ...
        newsletterDates: request.newsletterDates,
        annVideoDates: request.annVideoDates,
        tvScreensDates: request.tvScreensDates,
        connectionCardDates: request.connectionCardDates,
        reqId: requestId
      });
      ...
      return (
        <div className="container pt-4">
          <div className="row mb-5">
            <div className="col">
              <h2 className="mb-5 text-center">Edit a Communications Request</h2>
